...
const FormFields: React.FC<FormFieldsProps> = ({
  ...
  const totalSteps = 4;
  const [activeTab, setActiveTab] = useState<"account" | "salestab">("account");
    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex w-60 border-r pr-1 border-gray-300 flex-col">
          ...
          <button
            type="button"
            className={`flex items-center gap-2 px-4 py-4 rounded text-left ${activeTab === "salestab"
                ? "bg-blue-900 text-white"
                : "hover:bg-gray-100"
              }`}
            onClick={() => setActiveTab("salestab")}
          >
            <FcSalesPerformance className="text-lg" />
            SO & PO Information
          </button>
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="md:hidden">
              ...
              {step === 2 && (
                <SalesTab postData={postData} handleChange={handleChange} />
              )}
            </div>
