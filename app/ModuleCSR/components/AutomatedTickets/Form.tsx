        ...
        try {
            ...
            const response = await fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    Channel, WrapUp, Source, CustomerType, CustomerStatus, Status,
                    Amount, QtySold, SalesManager, SalesAgent, TicketReceived, TicketEndorsed,
                    TsmAcknowledgeDate, TsaAcknowledgeDate, TsmHandlingTime, TsaHandlingTime, Remarks, Traffic,
                    Inquiries, Department, ItemCode, ItemDescription, SONumber, PONumber,
                    QuotationNumber, QuotationAmount, SODate, PaymentTerms, PaymentDate, DeliveryDate,
                    POStatus, POSource, createdAt,
