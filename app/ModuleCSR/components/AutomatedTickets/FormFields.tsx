                    ...
                    <div className="flex flex-wrap -mx-4">
                        ...
                        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    const value = e.target.value;
                                    // Payagan lang numbers at maximum isang dot lang
                                    if (/^\d*\.?\d*$/.test(value)) {
                                        handleAmountChange(e);
                                    }
                                }}
                                className="w-full px-3 py-2 border rounded text-xs"
                                inputMode="decimal" // para sa mobile numeric keyboard na may dot
                            />
                        </div>
                        ...
                        <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    // Payagan lang digits, walang decimal or negative
                                    if (/^\d*$/.test(val)) {
                                        handleQtySoldChange(e);
                                    }
                                }}
                                className="w-full px-3 py-2 border rounded text-xs"
                                min={0}
