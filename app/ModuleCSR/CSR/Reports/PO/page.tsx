...
import Form from "../../../components/Reports/PO/Form";
import Table from "../../../components/Reports/PO/Table";
import SearchFilters from "../../../components/Reports/PO/SearchFilters";
import Pagination from "../../../components/Reports/PO/Pagination";
...
export default function Post() {
    ...
    const fetchPosts = async (refId: string) => {
        try {
            const res = await fetch(`/api/Backend/PO/fetch?id=${refId}`);
    ...
    const confirmDelete = async () => {
        ...
        try {
            const res = await fetch(`/api/Backend/PO/delete?id=${deleteTargetId}`, { method: "DELETE" });
