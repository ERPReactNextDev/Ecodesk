...
import Form from "../../components/ListAccounts/Form";
import Table from "../../components/ListAccounts/Table";
import SearchFilters from "../../components/ListAccounts/SearchFilters";
import Pagination from "../../components/ListAccounts/Pagination";
...
export default function Post() {
    ...
    const fetchPosts = async (refId: string) => {
        try {
            const res = await fetch(`/api/Backend/Account/fetch?id=${refId}`);
    ...
    const confirmDelete = async () => {
        ...
        try {
            const res = await fetch(`/api/Backend/Account/delete?id=${deleteTargetId}`, { method: "DELETE" });
