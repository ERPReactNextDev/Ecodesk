...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 bg-cover bg-left" style={{ backgroundImage: "url('/ticketing.jpg')" }}>
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 p-8 mt-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <input
              ...
              className="w-full rounded-md border border-green-300 bg-green-50 px-4 py-3 text-xs placeholder-green-600 shadow-sm transition focus:border-green-700 focus:ring-2 focus:ring-green-600 focus:outline-none"
            />
            <input
              type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-md bg-green-700 py-3 text-xs font-semibold text-white shadow-md transition hover:bg-green-600 hover:scale-105 disabled:cursor-not-allowed disabled:opacity-70"
            >
          ...
          <p className="mt-4 mb-3 text-[10px] italic text-gray-500">
            Ecodesk | Customer Ticketing System - Developed By Taskflow Team
          </p>
